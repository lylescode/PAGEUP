...
- (void)viewDidLayoutSubviews
{
    ...
    */
    ...
    previewImageView.frame = self.previewAreaView.frame;
...
- (void)requestPreviewImage
{
    ...
    self.previewImage = [self.exportDelegate exportViewControllerNeedPreviewImage];
...
- (void)requestResultImage
{
    self.resultImage = [self.exportDelegate exportViewControllerNeedResultImage];
}
...
- (void)shareToActivityController
{
    ...
    [self.exportDelegate exportViewControllerDidShareActivityWithImage:self.resultImage
                                                            completion:^{
                                                                [self shareComplete];
                                                            }];
}
